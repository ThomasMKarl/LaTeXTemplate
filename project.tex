...
%%%%%%%%%%%%%%%%%%%% eigentlicher Inhalt %%%%%%%%%%%%%%%%%%%%%% 
	...
	\input{/home/thomas/project/chapter1/chapter1.tex} %Einfuehrung?
	%\stopcontents[chapter1] %Definition beenden
	\input{/home/thomas/project/chapter2/chapter2.tex} %Theorie?
	% ....
	\input{/home/thomas/project/chapter3/chapter3.tex} %Zusammenfassung?
	
	\appendix
	\input{/home/thomas/project/appendix/appendixA.tex}
	\input{/home/thomas/project/appendix/appendixB.tex}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
