\section{section2}
	...
	\begin{table}[h] %import aus externer csv Datei
    	...
    	{/home/thomas/project/chapter1/section2/tables/table.csv}{name=\name,surname=\surname}%
		{\thecsvrow & \name & \surname}%			    
	...
	\begin{figure}
		\centering
		\scalebox{.8}{\input{/home/thomas/project/chapter1/section2/plots/plot.pgf}}
	...
	\begin{table}[h] %import aus externer csv Datei
    	...
    	{/home/thomas/project/chapter1/section2/tables/data.dat}{x=\x,y=\y}%
		{\thecsvrow & \x & \y}%			    
